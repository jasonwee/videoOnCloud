...
public final class CharacterStepBuilder {
	...
	/**
	 * First Builder Step in charge of the Character name. Next Step available :
	 * ClassStep
	 */
	 ...
	 * Fighter choice : Next Step available : WeaponStep Wizard choice : Next Step
	 * available : SpellStep
	 */
	...
	/**
	 * This step is in charge of the weapon. Weapon choice : Next Step available :
	 * AbilityStep No weapon choice : Next Step available : BuildStep
	 */
	...
	/**
	 * This step is in charge of the spell. Spell choice : Next Step available :
	 * AbilityStep No spell choice : Next Step available : BuildStep
	 */
	...
	/**
	 * This is the final step in charge of building the Character Object. Validation
	 * should be here.
	 */
